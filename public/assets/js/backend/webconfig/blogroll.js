    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                // showFooter: true,
                extend: {
                    index_url: 'webconfig/blogroll/index',
                    add_url: 'webconfig/blogroll/add',
                    edit_url: 'webconfig/blogroll/edit',
                    del_url: 'webconfig/blogroll/del', 
                    multi_url: 'webconfig/blogroll',
                    table: 'user',
                }
            });
            var table = $("#table");
