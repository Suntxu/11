    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                showFooter: true,
                extend: {
                    index_url: 'spread/expand/proindent/index',
                    table: 'user',
                }
            });
            var table = $("#table");
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        { field: 'c.status', title: '状态', formatter: Table.api.formatter.status,searchList: {'1':'已付款','0':'未付款'}, },
                        ...
                        { field: 'u.channel', title: '渠道名称', visible: false,searchList: $.getJSON('category/getSelectName') },
                ...
                queryParams: function (params) {
                    ...
                    var channel = $("#cel").val();
                    if (channel != '')
                        filter['c.channel'] = channel;
                    if (userid != '')
                        filter['c.userid'] = userid;
                    if(topspreader != ''){
                        filter['c.topspreader']=topspreader;
                    }
