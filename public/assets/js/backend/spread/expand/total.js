    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                // showFooter: true,
                extend: {
                    index_url: 'spread/expand/total/index',
                    table: 'user',
                }
            });
                ...
                columns: [
                    [
                       { field: 'ip', title: '访客ip', operate:false,formatter:Table.api.formatter.alink,url:'http://www.baidu.com/s',fieldvaleu:'ip',fieldname:'wd',tit:'充值记录',},
                        { field: 'top', title: '渠道名称', searchList: $.getJSON('category/getSelectName') },
                        { field: 'special_condition', title: '员工名称',},
                        { field: 'alink', title: '落地页',operate:'LIKE'},
