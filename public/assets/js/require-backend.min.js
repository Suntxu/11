...
define('table',['jquery', 'bootstrap', 'moment', 'form', 'moment/locale/zh-cn', 'bootstrap-table', 'bootstrap-table-lang', 'bootstrap-table-export', 'bootstrap-table-commonsearch', 'bootstrap-table-template', 'bootstrap-table-jumpto'], function ($, undefined, Moment,Form) {
    var Table = {
        list: {},
